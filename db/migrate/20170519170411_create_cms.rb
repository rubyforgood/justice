...
class CreateCms < ActiveRecord::Migration
  def self.up
    ...
    add_index :comfy_cms_categories, %i[site_id categorized_type label], unique: true,
    ...
    add_index :comfy_cms_categorizations, %i[category_id categorized_type categorized_id], unique: true,
